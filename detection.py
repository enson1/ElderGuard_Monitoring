...
_STANDALONE_BOT_TOKEN = os.environ.get('TELEGRAM_TOKEN', 'your_token_here') # Example: Use env var or default
_STANDALONE_CHAT_ID = os.environ.get('TELEGRAM_CHAT_ID', 'your_chat_id_here') # Example: Use env var or default
